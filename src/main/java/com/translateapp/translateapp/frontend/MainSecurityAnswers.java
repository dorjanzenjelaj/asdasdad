...
public class MainSecurityAnswers {

    public MainSecurityAnswers(Connection con, String email, JFrame jf) {
    ...
    private void initComponents(Connection con, String email, JFrame jf) {
        ...
        SecurityAnswersView panel = new SecurityAnswersView(con, email, jf);
        panelMain.add(panel);
